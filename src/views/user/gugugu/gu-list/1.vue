<template>
  <div>
    ...
    <svg class="icon" style="width: 10em; height: 10em;vertical-align: middle;fill: currentColor;overflow: hidden;"
         viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="500">
      <path d="M514.1 687.6m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#3E3A39" p-id="501"></path>
      <path d="M838.4 267.6m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#3E3A39" p-id="502"></path>
      <path
